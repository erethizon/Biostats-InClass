...
We need to look at the mean and growth rate of each of the combiations, so use group by and summarise
...
Think about this statement: *the efffect of supplement type on cow weight gain depends on the diet*
